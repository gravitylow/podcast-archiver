...
python archive_podcasts.py -u "https://example.com/podcast-feed.xml" -o "./downloads"

# Download all episodes with 5 threads
python archive_podcasts.py -u "https://example.com/podcast-feed.xml" -o "./downloads" -t 5

# Download only the 10 newest episodes
python archive_podcasts.py -u "https://example.com/podcast-feed.xml" -o "./downloads" -c 10
```
